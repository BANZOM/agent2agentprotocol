...
from .agent_executor import KaitAgentExecutor
from .card import build_agent_card, HOST, PORT


def main():
    agent_card = build_agent_card()
    handler = DefaultRequestHandlerV2(
        agent_executor=KaitAgentExecutor(),
    ...
    print(f"[Kait Agent - CrewAI] running at http://{HOST}:{PORT}")
